import { RaindropLinkType, RaindropCollectionTree } from '../models/raindrop-links';
 ...
 */
export function getRaindropCollectionTreeView(collections: readonly RaindropCollectionTree[]): string {
  if (!collections || collections.length === 0) {
    return '';
  }

  function renderCollection(collection: RaindropCollectionTree, level = 0): string {
    let html = '';
